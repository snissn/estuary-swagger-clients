...
{ 
    ...
    { 
        ...
        [HttpGet]
        [Route("//api.estuary.tech//user/api-keys")]
        ...
        [HttpDelete]
        [Route("//api.estuary.tech//user/api-keys/{key}")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="200">OK</response>
        [HttpGet]
        [Route("//api.estuary.tech//user/export")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="200">OK</response>
        [HttpGet]
        [Route("//api.estuary.tech//user/stats")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        { 
            ...
            exampleJson = "{\n  \"totalSize\" : 6,\n  \"numPins\" : 0\n}";
                        ...
                        : default(MainUserStatsResponse);            //TODO: Change the data returned
            return new ObjectResult(example);
        }
    }
}
