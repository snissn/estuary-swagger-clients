...
namespace IO.Swagger.Api
{
 ...
 if (size != null) queryParams.Add("size", ApiClient.ParameterToString(size)); // query parameter
        ...
        /// <param name="dir">Directory</param>
        /// <returns>UtilContentAddResponse</returns>
        public UtilContentAddResponse ContentAddPost (byte[] file, string coluuid, string dir)
        {
            // verify the required parameter 'file' is set
            if (file == null) throw new ApiException(400, "Missing required parameter 'file' when calling ContentAddPost");
