...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyDIServerCodegen", date = "2022-09-27T20:40:37.264153-10:00[Pacific/Honolulu]")public class CollectionsApi  {

   private CollectionsApiService delegate;

   protected CollectionsApi() {
   }

   @javax.inject.Inject
   public CollectionsApi(CollectionsApiService delegate) {
...
,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = String.class))) })
    public Response collectionsColuuidGet(@Parameter(in = ParameterIn.QUERY, description = "Collection UUID",required=true) @QueryParam("coluuid") String coluuid
...
,@Context SecurityContext securityContext)
    ...
    public Response collectionsGet(@Parameter(in = ParameterIn.PATH, description = "User ID",required=true) @PathParam("id") Integer id
,@Context SecurityContext securityContext)
    throws NotFoundException {
