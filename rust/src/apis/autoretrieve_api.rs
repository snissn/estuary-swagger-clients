...
pub struct AutoretrieveApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> AutoretrieveApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> AutoretrieveApiClient<C> {
        AutoretrieveApiClient {
...
impl<C: hyper::client::Connect>AutoretrieveApi for AutoretrieveApiClient<C> {
    fn admin_autoretrieve_init_post(&self, addresses: &str, pub_key: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/admin/autoretrieve/init?{}", configuration.base_path, query_string);
    ...
    fn admin_autoretrieve_list_get(&self, ) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/admin/autoretrieve/list?{}", configuration.base_path, query_string);
    ...
    fn autoretrieve_heartbeat_post(&self, token: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/autoretrieve/heartbeat?{}", configuration.base_path, query_string);
