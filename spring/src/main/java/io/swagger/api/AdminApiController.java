...
public class AdminApiController implements AdminApi {
    ...
    public ResponseEntity<Void> adminAutoretrieveInitPost(@Parameter(in = ParameterIn.DEFAULT, description = "Autoretrieve's public key", required=true, schema=@Schema()) @Valid @RequestBody String body) {
