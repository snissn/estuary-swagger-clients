...
public interface CollectionsApi {
    ...
    @Delete(value = "/collections/{coluuid}")
    default Single<HttpResponse<Void>> collectionsColuuidDelete(@Parameter(description = "Collection ID") @PathVariable("coluuid") String coluuid
) {
        return Single.fromCallable(() -> {
            throw new UnsupportedOperationException();
        });
    ...
    default Single<HttpResponse<String>> collectionsColuuidGet(@NotNull @Parameter(description = "Collection UUID") @Valid @QueryValue(value = "coluuid") String coluuid
,@Nullable @Parameter(description = "Directory") @Valid @QueryValue(value = "dir") String dir
    ...
    default Single<HttpResponse<Map<String, String>>> collectionsColuuidPost(@Parameter(description = "Content IDs to add to collection") @Valid @Body List<Integer> body
) {
        return Single.fromCallable(() -> {
            throw new UnsupportedOperationException();
        });
    ...
    @Post(value = "/collections/fs/add")
    default Single<HttpResponse<Void>> collectionsFsAddPost(@NotNull @Parameter(description = "Collection ID") @Valid @QueryValue(value = "coluuid") String coluuid
...
,@NotNull @Parameter(description = "Path to file") @Valid @QueryValue(value = "path") String path
    ...
    default Single<HttpResponse<List<MainCollection>>> collectionsGet(@Parameter(description = "User ID") @PathVariable("id") Integer id
) {
        return Single.fromCallable(() -> {
            throw new UnsupportedOperationException();
        });
    ...
    default Single<HttpResponse<MainCollection>> collectionsPost(@Parameter(description = "Collection name and description") @Valid @Body MainCreateCollectionBody body
) {
        return Single.fromCallable(() -> {
            throw new UnsupportedOperationException();
        });
