...
const BASE_PATH = "//api.estuary.tech/".replace(/\/+$/, "");
...
export const AutoretrieveApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        adminAutoretrieveInitPost(body: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling adminAutoretrieveInitPost.');
            }
...
export const AutoretrieveApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        adminAutoretrieveInitPost(body: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = AutoretrieveApiFetchParamCreator(configuration).adminAutoretrieveInitPost(body, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const AutoretrieveApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        adminAutoretrieveInitPost(body: string, options?: any) {
            return AutoretrieveApiFp(configuration).adminAutoretrieveInitPost(body, options)(fetch, basePath);
        },
        /**
         * This endpoint lists all registered autoretrieve servers
         * @summary List autoretrieve servers
...
export class AutoretrieveApi extends BaseAPI {
     ...
     */
    public adminAutoretrieveInitPost(body: string, options?: any) {
        return AutoretrieveApiFp(this.configuration).adminAutoretrieveInitPost(body, options)(this.fetch, this.basePath);
    }
...
export const ContentApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        contentAddPost(file: Blob, coluuid: string, dir: string, options: any = {}): FetchArgs {
...
export const ContentApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        contentAddPost(file: Blob, coluuid: string, dir: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<UtilContentAddResponse> {
...
export const ContentApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        contentAddPost(file: Blob, coluuid: string, dir: string, options?: any) {
...
export class ContentApi extends BaseAPI {
     ...
     * @memberof ContentApi
     */
    public contentAddPost(file: Blob, coluuid: string, dir: string, options?: any) {
...
export const DealsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        dealsMakeMinerPost(body: string, miner: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const DealsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        dealsMakeMinerPost(body: string, miner: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = DealsApiFetchParamCreator(configuration).dealsMakeMinerPost(body, miner, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const DealsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        dealsMakeMinerPost(body: string, miner: string, options?: any) {
            return DealsApiFp(configuration).dealsMakeMinerPost(body, miner, options)(fetch, basePath);
        },
        /**
         * This endpoint returns the status of a deal
         * @summary Get Deal Status
...
export class DealsApi extends BaseAPI {
     ...
     * @memberof DealsApi
     */
    public dealsMakeMinerPost(body: string, miner: string, options?: any) {
        return DealsApiFp(this.configuration).dealsMakeMinerPost(body, miner, options)(this.fetch, this.basePath);
    }
