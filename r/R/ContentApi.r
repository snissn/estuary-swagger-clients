...
ContentApi <- R6::R6Class(
  ...
  public = list(
    ...
    content_add_car_post = function(body, filename, commp, size, ...){
      args <- list(...)
      queryParams <- list()
    ...
    content_add_ipfs_post = function(body, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    content_create_post = function(body, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    content_stats_get = function(limit, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
