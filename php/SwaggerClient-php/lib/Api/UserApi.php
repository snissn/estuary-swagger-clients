...
class UserApi
{
    ...
    {
        list($response) = $this->userApiKeysGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation userApiKeysGetWithHttpInfo
     *
     * Get API keys for a user
     *
     *
     ...
     */
    public function userApiKeysGetAsync()
    {
        return $this->userApiKeysGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userApiKeysGetAsyncWithHttpInfo
     *
     * Get API keys for a user
     *
     *
    ...
    /**
     * Create request for operation 'userApiKeysGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userApiKeysGetRequest()
    {
    ...
    /**
     * Operation userApiKeysPostWithHttpInfo
     *
     * Create API keys for a user
     *
     *
    ...
    /**
     * Operation userApiKeysPostAsync
     *
     * Create API keys for a user
     *
     *
    ...
    /**
     * Operation userApiKeysPostAsyncWithHttpInfo
     *
     * Create API keys for a user
     *
     *
     ...
     * @return string
     */
    public function userExportGet()
    {
        list($response) = $this->userExportGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation userExportGetWithHttpInfo
     *
     * Export user data
     *
     *
     ...
     */
    public function userExportGetWithHttpInfo()
    {
        $returnType = 'string';
        $request = $this->userExportGetRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userExportGetAsync()
    {
        return $this->userExportGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userExportGetAsyncWithHttpInfo
     *
     * Export user data
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userExportGetAsyncWithHttpInfo()
    {
        $returnType = 'string';
        $request = $this->userExportGetRequest();
    ...
    /**
     * Create request for operation 'userExportGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userExportGetRequest()
    {

        $resourcePath = '/user/export';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->userStatsGetWithHttpInfo();
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userStatsGetAsync()
    {
        return $this->userStatsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Create request for operation 'userStatsGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userStatsGetRequest()
    {

        $resourcePath = '/user/stats';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
