...
class AutoretrieveApi
{
     ...
     *
     * @param  string $body Autoretrieve&#x27;s public key (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function adminAutoretrieveInitPost($body)
    {
        $this->adminAutoretrieveInitPostWithHttpInfo($body);
    }
     ...
     */
    public function adminAutoretrieveInitPostWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->adminAutoretrieveInitPostRequest($body);
     ...
     */
    public function adminAutoretrieveInitPostAsync($body)
    {
        return $this->adminAutoretrieveInitPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminAutoretrieveInitPostAsyncWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->adminAutoretrieveInitPostRequest($body);
     ...
     */
    protected function adminAutoretrieveInitPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling adminAutoretrieveInitPost'
            );
        }
