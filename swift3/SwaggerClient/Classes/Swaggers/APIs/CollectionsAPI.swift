...
open class CollectionsAPI: APIBase {
    /**
     Produce a CID of the collection contents
     - parameter coluuid: (path) coluuid 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func collectionsColuuidCommitPost(coluuid: String, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
  ...
  "empty": true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func collectionsColuuidContentsDelete(coluuid: String, contentid: String, body: MainDeleteContentFromCollectionBody, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
  ...
  "empty": true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func collectionsColuuidGet(coluuid: String, dir: String? = nil, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
  ...
  "empty": true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func collectionsColuuidPost(body: [Int32], completion: @escaping ((_ data: [String:String]?, _ error: ErrorResponse?) -> Void)) {
     ...
     */
    open class func collectionsColuuidPostWithRequestBuilder(body: [Int32]) -> RequestBuilder<[String:String]> {
