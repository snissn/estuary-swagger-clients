...
class DealsApi(object):
    ...
    def deal_transfer_status_post(self, **kwargs):  # noqa: E501
        """Transfer Status  # noqa: E501

        This endpoint returns the status of a transfer  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deal_transfer_status_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.deal_transfer_status_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.deal_transfer_status_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def deal_transfer_status_post_with_http_info(self, **kwargs):  # noqa: E501
        """Transfer Status  # noqa: E501

        This endpoint returns the status of a transfer  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deal_transfer_status_post_with_http_info(async_req=True)
        >>> result = thread.get()
