...
namespace IO.Swagger.Api
{
        ...
        public interface IAutoretrieveApi : IApiAccessor
    {
        ...
        ApiResponse<Object> AdminAutoretrieveInitPostWithHttpInfo (string body);
        /// <summary>
        ...
        System.Threading.Tasks.Task AdminAutoretrieveInitPostAsync (string body);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AdminAutoretrieveInitPostAsyncWithHttpInfo (string body);
        /// <summary>
        /// List autoretrieve servers
        /// </summary>
        /// <remarks>
        ...
        public partial class AutoretrieveApi : IAutoretrieveApi
    {
        ...
        /// <param name="body">Autoretrieve&#x27;s public key</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AdminAutoretrieveInitPostWithHttpInfo (string body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AutoretrieveApi->AdminAutoretrieveInitPost");
        ...
        /// <param name="body">Autoretrieve&#x27;s public key</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AdminAutoretrieveInitPostAsync (string body)
        {
             await AdminAutoretrieveInitPostAsyncWithHttpInfo(body);
        ...
        /// <param name="body">Autoretrieve&#x27;s public key</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> AdminAutoretrieveInitPostAsyncWithHttpInfo (string body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AutoretrieveApi->AdminAutoretrieveInitPost");
