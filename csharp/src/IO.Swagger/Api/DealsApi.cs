...
namespace IO.Swagger.Api
{
        ...
        public interface IDealsApi : IApiAccessor
    {
        ...
        /// <param name="miner">Miner</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DealsMakeMinerPostWithHttpInfo (string body, string miner);
        /// <summary>
        /// Get Deal Status
        /// </summary>
        /// <remarks>
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DealsMakeMinerPostAsync (string body, string miner);
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DealsMakeMinerPostAsyncWithHttpInfo (string body, string miner);
        /// <summary>
        /// Get Deal Status
        /// </summary>
        /// <remarks>
        ...
        public partial class DealsApi : IDealsApi
    {
        ...
        {
             DealsMakeMinerPostWithHttpInfo(body, miner);
        }
        ...
        /// <param name="miner">Miner</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DealsMakeMinerPostWithHttpInfo (string body, string miner)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DealsApi->DealsMakeMinerPost");
            // verify the required parameter 'miner' is set
            if (miner == null)
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DealsMakeMinerPostAsync (string body, string miner)
        {
             await DealsMakeMinerPostAsyncWithHttpInfo(body, miner);
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DealsMakeMinerPostAsyncWithHttpInfo (string body, string miner)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DealsApi->DealsMakeMinerPost");
