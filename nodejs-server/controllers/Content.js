...
module.exports.contentAddPOST = function contentAddPOST (req, res, next, coluuid, dir) {
  Content.contentAddPOST(coluuid, dir)
...
module.exports.contentAdd_carPOST = function contentAdd_carPOST (req, res, next, body, filename, commp, size) {
...
module.exports.contentAdd_ipfsPOST = function contentAdd_ipfsPOST (req, res, next, body) {
...
module.exports.contentCreatePOST = function contentCreatePOST (req, res, next, body) {
...
module.exports.contentStatsGET = function contentStatsGET (req, res, next, limit) {
