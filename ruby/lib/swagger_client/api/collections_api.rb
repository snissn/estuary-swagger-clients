...
module SwaggerClient
  class CollectionsApi
    ...
    # @param id User ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<MainCollection>, Integer, Hash)>] Array<MainCollection> data, response status code and response headers
    def collections_get_with_http_info(id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<MainCollection>' 
    ...
    # @param body Collection name and description
    # @param [Hash] opts the optional parameters
    # @return [Array<(MainCollection, Integer, Hash)>] MainCollection data, response status code and response headers
    def collections_post_with_http_info(body, opts = {})
      ...
      return_type = opts[:return_type] || 'MainCollection' 
