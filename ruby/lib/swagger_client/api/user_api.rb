...
module SwaggerClient
  class UserApi
    ...
    # This endpoint is used to create API keys for a user.
    # @param [Hash] opts the optional parameters
    # @return [Array<(MainUserStatsResponse, Integer, Hash)>] MainUserStatsResponse data, response status code and response headers
    def user_stats_get_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'MainUserStatsResponse' 
