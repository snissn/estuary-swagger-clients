...
module SwaggerClient
  class AutoretrieveApi
    ...
    # @return [nil]
    def admin_autoretrieve_init_post(body, opts = {})
      admin_autoretrieve_init_post_with_http_info(body, opts)
      nil
    end
    ...
    def admin_autoretrieve_init_post_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AutoretrieveApi.admin_autoretrieve_init_post ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AutoretrieveApi.admin_autoretrieve_init_post"
      end
      # resource path
