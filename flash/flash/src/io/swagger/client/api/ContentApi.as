...
public class ContentApi extends SwaggerApi {
    ...
    */
     ...
     * Returns void 
     */
    public function content_add_car_post (body: String, filename: String, commp: String, size: String): String {
...
if("null" != String(commp))
            queryParams["commp"] = toPathValue(commp);
if("null" != String(size))
     ...
     * Returns void 
     */
    public function content_add_ipfs_post (body: UtilContentAddIpfsBody): String {
        // create path and map variables
...
if("null" != String(all))
     ...
     * Returns void 
     */
    public function content_create_post (body: String): String {
        // create path and map variables
...
if("null" != String(offset))
     ...
     * Returns void 
     */
    public function content_stats_get (limit: String): String {
        // create path and map variables
        var path: String = "/content/stats".replace(/{format}/g,"xml").replace("{" + "limit" + "}", getApiInvoker().escapeString(limit));
