...
@implementation SWGAutoretrieveApi

NSString* kSWGAutoretrieveApiErrorDomain = @"SWGAutoretrieveApiErrorDomain";
NSInteger kSWGAutoretrieveApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) adminAutoretrieveInitPostWithAddresses: (NSString*) addresses
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/admin/autoretrieve/init"];
...
-(NSURLSessionTask*) autoretrieveHeartbeatPostWithToken: (NSString*) token
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/autoretrieve/heartbeat"];
