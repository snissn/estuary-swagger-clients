...
@implementation SWGContentApi

NSString* kSWGContentApiErrorDomain = @"SWGContentApiErrorDomain";
NSInteger kSWGContentApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) contentAddCarPostWithBody: (NSString*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/add-car"];
...
-(NSURLSessionTask*) contentAddIpfsPostWithBody: (SWGUtilContentAddIpfsBody*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/add-ipfs"];
...
-(NSURLSessionTask*) contentAddPostWithData: (NSURL*) data
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGUtilContentAddResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGUtilContentAddResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) contentAggregatedContentGetWithContent: (NSString*) content
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/aggregated/{content}"];
...
-(NSURLSessionTask*) contentAllDealsGetWithBegin: (NSString*) begin
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/all-deals"];
...
-(NSURLSessionTask*) contentBwUsageContentGetWithContent: (NSString*) content
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/bw-usage/{content}"];
...
-(NSURLSessionTask*) contentCreatePostWithBody: (NSString*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/create"];
...
-(NSURLSessionTask*) contentEnsureReplicationDatacidGetWithDatacid: (NSString*) datacid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/ensure-replication/{datacid}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (datacid != nil) {
        pathParams[@"datacid"] = datacid;
    }
...
-(NSURLSessionTask*) contentFailuresContentGetWithContent: (NSString*) content
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/failures/{content}"];
...
-(NSURLSessionTask*) contentImportdealPostWithBody: (SWGMainImportDealBody*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/importdeal"];
...
-(NSURLSessionTask*) contentReadContGetWithCont: (NSString*) cont
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/read/{cont}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (cont != nil) {
        pathParams[@"cont"] = cont;
    }
...
-(NSURLSessionTask*) contentStatusIdGetWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/content/status/{id}"];
