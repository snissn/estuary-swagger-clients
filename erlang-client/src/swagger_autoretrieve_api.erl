-module(swagger_autoretrieve_api).
...
-spec admin_autoretrieve_init_post(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
-spec admin_autoretrieve_list_get(ctx:ctx()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
admin_autoretrieve_list_get(Ctx) ->
    admin_autoretrieve_list_get(Ctx, #{}).

-spec admin_autoretrieve_list_get(ctx:ctx(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
-spec autoretrieve_heartbeat_post(ctx:ctx(), binary()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
autoretrieve_heartbeat_post(Ctx, Token) ->
    autoretrieve_heartbeat_post(Ctx, Token, #{}).

-spec autoretrieve_heartbeat_post(ctx:ctx(), binary(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
autoretrieve_heartbeat_post(Ctx, Token, Optional) ->
    ...
    QS = [],
    Headers = [{<<"token">>, Token}]++swagger_utils:optional_params([], _OptionalParams),
    Body1 = [],
    ContentTypeHeader = swagger_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
