...
public class PinningApi  {
  ...
  @Inject PinningApiService delegate;
    ...
    @ApiResponses(value = {  })
    public Response pinningPinsPost(@ApiParam(value = "cid",required=true) @PathParam("cid") String cid, @ApiParam(value = "name",required=true) @PathParam("name") String name) {
