...
export const MinerApiFp = function(configuration?: Configuration) {
    return {
        ...
        async publicMinersDealsMinerGet(miner: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await MinerApiAxiosParamCreator(configuration).publicMinersDealsMinerGet(miner, options);
...
export const MinerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async publicMinersDealsMinerGet(miner: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return MinerApiFp(configuration).publicMinersDealsMinerGet(miner, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint returns miner stats
         * @summary Get miner stats
...
export class MinerApi extends BaseAPI {
    ...
    public async publicMinersDealsMinerGet(miner: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return MinerApiFp(this.configuration).publicMinersDealsMinerGet(miner, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint returns miner stats
     * @summary Get miner stats
