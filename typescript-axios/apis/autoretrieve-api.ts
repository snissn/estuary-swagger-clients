...
export const AutoretrieveApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        adminAutoretrieveInitPost: async (body: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AutoretrieveApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async adminAutoretrieveInitPost(body: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await AutoretrieveApiAxiosParamCreator(configuration).adminAutoretrieveInitPost(body, options);
         ...
         * @throws {RequiredError}
         */
        async adminAutoretrieveListGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
         ...
         * @throws {RequiredError}
         */
        async autoretrieveHeartbeatPost(token: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
...
export const AutoretrieveApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async adminAutoretrieveInitPost(body: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return AutoretrieveApiFp(configuration).adminAutoretrieveInitPost(body, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint lists all registered autoretrieve servers
         * @summary List autoretrieve servers
         ...
         * @throws {RequiredError}
         */
        async adminAutoretrieveListGet(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
         ...
         * @throws {RequiredError}
         */
        async autoretrieveHeartbeatPost(token: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
...
export class AutoretrieveApi extends BaseAPI {
     ...
     */
    public async adminAutoretrieveInitPost(body: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return AutoretrieveApiFp(this.configuration).adminAutoretrieveInitPost(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint lists all registered autoretrieve servers
     * @summary List autoretrieve servers
     ...
     * @memberof AutoretrieveApi
     */
    public async adminAutoretrieveListGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
     ...
     * @memberof AutoretrieveApi
     */
    public async autoretrieveHeartbeatPost(token: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
