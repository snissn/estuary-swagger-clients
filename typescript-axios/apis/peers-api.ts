...
export const PeersApiFp = function(configuration?: Configuration) {
    return {
        ...
        async adminPeeringPeersDelete(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await PeersApiAxiosParamCreator(configuration).adminPeeringPeersDelete(options);
...
export const PeersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async adminPeeringPeersDelete(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return PeersApiFp(configuration).adminPeeringPeersDelete(options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint can be used to list all peers on Peering Service
         * @summary List all Peering peers
...
export class PeersApi extends BaseAPI {
    ...
    public async adminPeeringPeersDelete(options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return PeersApiFp(this.configuration).adminPeeringPeersDelete(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint can be used to list all peers on Peering Service
     * @summary List all Peering peers
