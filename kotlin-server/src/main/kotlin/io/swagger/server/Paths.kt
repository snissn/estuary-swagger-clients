...
object Paths {
     ...
     */
    @Location("/admin/autoretrieve/init") class adminAutoretrieveInitPost(val body: kotlin.String)
     ...
     */
    @Location("/collections/{coluuid}") class collectionsColuuidPost(val body: kotlin.Array<kotlin.Int>)
     ...
     */
    @Location("/content/add-car") class contentAddCarPost(val body: kotlin.String, val filename: kotlin.String, val commp: kotlin.String, val size: kotlin.String)
     ...
     */
    @Location("/content/add-ipfs") class contentAddIpfsPost(val body: UtilContentAddIpfsBody)
     ...
     * @param dir Directory 
     */
    @Location("/content/add") class contentAddPost(val file: kotlin.Array<kotlin.Byte>, val coluuid: kotlin.String, val dir: kotlin.String)
     ...
     * @param body Content 
     */
    @Location("/content/create") class contentCreatePost(val body: kotlin.String)
     ...
     */
    @Location("/deal/transfer/status") class dealTransferStatusPost()
     ...
     * @param pinid Pin ID 
     */
    @Location("/pinning/pins/{pinid}") class pinningPinsPinidPost(val pinid: kotlin.String)
     ...
     * @param name name 
     */
    @Location("/pinning/pins") class pinningPinsPost(val cid: kotlin.String, val name: kotlin.String)
     ...
     */
    @Location("/user/api-keys") class userApiKeysPost()
