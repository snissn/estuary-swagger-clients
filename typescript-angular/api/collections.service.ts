...
export class CollectionsService {
    ...
    public collectionsColuuidDelete(coluuid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/collections/${encodeURIComponent(String(coluuid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public collectionsColuuidPost(body: Array<number>, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<{ [key: string]: string; }>('post',`${this.basePath}/collections/${encodeURIComponent(String(coluuid))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public collectionsFsAddPost(coluuid: string, content: string, path: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/collections/fs/add`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public collectionsGet(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<MainCollection>>('get',`${this.basePath}/collections/`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public collectionsPost(body: MainCreateCollectionBody, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<MainCollection>('post',`${this.basePath}/collections/`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
